...
def test(model, train_user, test_user, n_u, n_i, user_emb, item_emb):
    ...
    train_user_set = train_user
    test_user_set = test_user
    ...
    entity_gcn_emb = item_emb
    user_gcn_emb = user_emb
